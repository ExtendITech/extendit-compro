...
import { Code2, Cpu, Palette, TrendingUp, Calculator } from 'lucide-react';
  ...
  const services = [
    {
      icon: Code2,
      title: 'Tech Solution',
      description: 'Custom software development with cutting-edge technologies. From web to mobile, we build scalable solutions.',
      tags: ['React', 'Node.js', 'Cloud'],
    },
    {
      icon: Cpu,
      title: 'AI Solution',
      description: 'Intelligent automation and machine learning integration. Transform your business with AI-powered insights.',
      tags: ['ML', 'NLP', 'Automation'],
    },
    {
      icon: Palette,
      title: 'Product & Design (UI/UX)',
      description: 'Beautiful, intuitive interfaces that users love. Research-driven design that converts.',
      tags: ['Figma', 'Prototyping', 'Testing'],
    },
    {
      icon: TrendingUp,
      title: 'Performance Marketing',
      description: 'Data-driven campaigns that drive real results. SEO, SEM, and growth hacking strategies.',
      tags: ['Analytics', 'Growth', 'ROI'],
    },
    {
      icon: Calculator,
      title: 'Prompt & Budget Estimator',
      description: 'Get instant project estimates and AI-powered prompts. Plan smarter, ship faster.',
    ...
    <div className="relative min-h-screen bg-background text-foreground overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 font-mono">
              <span className="text-primary glow-primary text-xl font-bold">{'<Extend IT />'}</span>
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 font-mono">
              We craft experiences that redefine the future. From innovative software to groundbreaking 
              hardware, we're dedicated to shaping a connected world where innovation knows no bounds.
            </p>
      ...
      <section className="relative py-20 px-4 bg-gradient-to-b from-background to-muted/20">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <span className="text-primary font-mono text-sm glow-primary">$ cat about.txt</span>
            <h2 className="text-3xl md:text-5xl font-bold mt-2 mb-6">
              We Are <span className="text-primary glow-primary">Extend IT</span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              A dynamic tech company creating innovative solutions that solve real-world challenges. 
              We craft experiences that redefine the future, building a connected world where innovation 
              knows no bounds. From groundbreaking software to revolutionary hardware, we're your partners 
      ...
      <section className="relative py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="mb-12"
          >
            <span className="text-primary font-mono text-sm glow-primary">$ ls services/</span>
            <h2 className="text-3xl md:text-4xl font-bold mt-2 mb-4">
              Our <span className="text-secondary glow-secondary">Services</span>
            </h2>
      ...
      <section className="relative py-20 px-4 bg-gradient-to-b from-transparent to-muted/20">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <span className="text-primary font-mono text-sm glow-primary">$ git log partners</span>
            <h2 className="text-3xl md:text-4xl font-bold mt-2 mb-4">
              Trusted <span className="text-primary glow-primary">Partners</span>
            </h2>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="mb-8 text-center">
              <span className="text-primary font-mono text-sm glow-primary">$ ./contact.sh</span>
              <h2 className="text-3xl md:text-4xl font-bold mt-2 mb-4">
                Let's <span className="text-secondary glow-secondary">Build Together</span>
              </h2>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="font-mono">
              <span className="text-primary glow-primary font-bold">{'<Extend IT />'}</span>
