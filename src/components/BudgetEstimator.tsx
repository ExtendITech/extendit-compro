				...
				>
					<div className="mb-8">
						...
						<h2 className="text-3xl md:text-4xl font-bold mt-2 mb-4">
							Quick Budget{" "}
							<span className="text-primary glow-primary">Estimator</span>
						</h2>
						<p className="text-muted-foreground">
							Get an instant estimate for your project. Real developers, real
							results.
						</p>
					</div>
						...
						<div className="grid md:grid-cols-2 gap-6 mb-6">
							...
							<div className="md:col-span-2">
								...
								<Input
									...
									value={integrations}
									onChange={(e) =>
										setIntegrations(parseInt(e.target.value) || 0)
									}
									className="bg-background border-border"
									placeholder="0"
								/>
